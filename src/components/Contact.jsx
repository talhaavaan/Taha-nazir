...
export default function Contact() {
  ...
  return (
    <section id="contact" style={{ padding:'8rem 0', position:'relative', borderTop:'1px solid hsl(var(--stroke))' }}>
      <div style={{ position:'absolute', top:0, left:'50%', transform:'translateX(-50%)', width:600, height:400, background:'radial-gradient(ellipse,rgba(255,138,61,0.05),transparent)', pointerEvents:'none' }} />
      ...
      <div style={{ maxWidth:1280, margin:'0 auto', padding:'0 2rem' }}>
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(300px,1fr))', gap:'4rem', alignItems:'start' }}>
          ...
          >
            {submitted ? (
              <div style={{ textAlign:'center', padding:'3rem', border:'1px solid rgba(255,138,61,0.3)', borderRadius:20, background:'hsl(var(--surface))' }}>

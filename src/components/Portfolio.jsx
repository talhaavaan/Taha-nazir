...
const PROJECTS = [
  { cat: 'Wedding',      title: '',                       year: '2024', ratio: '9/16', video: '/wedding-edit.mp4',       bg: 'linear-gradient(135deg,#16131f,#0d1a1a)', accent: '#b39ddb' },
  { cat: 'Cuties <3',    title: '',                       year: '2024', ratio: '9/16', video: '/lawn.mp4',               bg: 'linear-gradient(135deg,#1a1218,#0d1020)', accent: '#e8b8c5' },
  { cat: 'Commercial',   title: '',                       year: '2024', ratio: '9/16', video: '/badass-edit.mov',        bg: 'linear-gradient(135deg,#0f1a1a,#1a1518)', accent: '#cfd8a5' },
  { cat: 'Commercial',   title: '',                       year: '2025', ratio: '1/1',  video: '/kashish.mov',            bg: 'linear-gradient(135deg,#1a140d,#0d1a14)', accent: '#e8b48a' },
  { cat: 'Commercial',   title: '',                       year: '2025', ratio: '9/16', video: '/Penthouse%20Showcase.mp4', bg: 'linear-gradient(135deg,#0d1a14,#121a0d)', accent: '#9ccfa8' },
];
...
function Frame({ p, index, playingId, setPlayingId }) {
  ...
  return (
    ...
    >
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              >
                ...
                <div style={{ position: 'absolute', top: '50%', left: `${progress * 100}%`, transform: 'translate(-50%,-50%)', width: 10, height: 10, borderRadius: 2, background: '#fff', boxShadow: '0 0 6px rgba(0,0,0,0.5)' }} />
              </div>
      ...
      <style>{`
        input[type=range]::-webkit-slider-thumb { -webkit-appearance:none; width:10px; height:10px; border-radius:2px; background:#fff; cursor:pointer; }
        input[type=range]::-moz-range-thumb { width:10px; height:10px; border-radius:2px; background:#fff; border:none; cursor:pointer; }
      `}</style>
    </motion.figure>
  );
}
...
export default function Portfolio() {
  ...
  return (
    <section style={{ position: 'relative', background: '#0b0d12', color: '#fff', padding: '120px 48px 140px', overflow: 'hidden' }}>
      ...
      <div aria-hidden style={{ position: 'absolute', top: '-10%', left: '-10%', width: 600, height: 600, background: 'radial-gradient(circle, rgba(255,138,61,0.14) 0%, transparent 60%)', pointerEvents: 'none' }} />
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', flexWrap: 'wrap', gap: 24, marginBottom: 28 }}>
          <div>
            ...
            <h2 style={{ margin: 0, fontFamily: "'Instrument Serif',serif", fontSize: 'clamp(3rem, 7vw, 6rem)', lineHeight: 0.98, letterSpacing: '-0.02em' }}>
              Featured <span style={{ fontStyle: 'italic', color: '#ff8a3d' }}>projects.</span>
            </h2>

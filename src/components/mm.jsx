      ...
      <div style={{
        ...
        <motion.div
          ...
          style={{
            ...
            background: 'radial-gradient(circle, rgba(255,138,61,0.22), transparent 60%)',
            filter: 'blur(20px)',
        ...
        >
          ...
          <svg width="92" height="92" viewBox="0 0 80 80" fill="none" style={{ opacity: 0.25 }}>
            ...
            <defs><linearGradient id="ag2" x1="0" y1="0" x2="1" y2="0"><stop stopColor="#FF8A3D" /><stop offset="1" stopColor="#E63946" /></linearGradient></defs>
          </svg>
          <span style={{
          ...
          <motion.div
            style={{
              ...
              background: 'hsl(var(--bg))', border: '1px solid rgba(255,138,61,0.4)',
        ...
        >
          <div style={{
            ...
            {skills.map(s => (
              <span key={s} style={{
                padding: '.5rem 1.1rem', border: '1px solid rgba(255,138,61,0.35)',

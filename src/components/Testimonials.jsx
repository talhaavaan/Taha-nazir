...
// TODO: replace these with Ajey's real client testimonials before publishing
const testimonials = [
  {
    name: 'Client Name',
    role: 'Content Creator',
    project: 'Short Form Content',
    text: 'Placeholder testimonial — replace with a real quote about Ajey\'s speed ramping and editing work.',
    initials: 'CN',
  ...
  },
  {
    ...
    text: 'Placeholder testimonial — replace with a real quote about the campaign Ajey edited.',
    initials: 'CN',
  ...
  },
  {
    ...
    text: 'Placeholder testimonial — replace with a real quote about the channel growth Ajey helped drive.',
    initials: 'CN',
  ...
  },
  {
    ...
    project: 'Reels / Speed Ramping',
    text: 'Placeholder testimonial — replace with a real quote about a speed-ramped reel or edit.',
    initials: 'CN',

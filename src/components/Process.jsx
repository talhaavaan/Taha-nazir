          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div style={{
                ...
                onMouseEnter={e=>{e.currentTarget.style.borderColor='rgba(255,138,61,0.8)';e.currentTarget.style.boxShadow='0 0 20px rgba(255,138,61,0.15)';}}
                onMouseLeave={e=>{e.currentTarget.style.borderColor='rgba(255,138,61,0.4)';e.currentTarget.style.boxShadow='none';}}
              >

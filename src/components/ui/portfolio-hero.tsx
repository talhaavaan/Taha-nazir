      ...
      {isExpanded && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/80 p-4">
          <button
            ...
            className="absolute top-4 right-4 text-white text-2xl font-bold rounded-full bg-black/60 w-12 h-12 flex items-center justify-center"
            aria-label="Close expanded image"
          >
            ×
          </button>
          <div className="relative max-w-[90vw] max-h-[90vh] overflow-hidden rounded-3xl shadow-2xl bg-black">
            <img
              src="/talha-avaan.jpeg"
              alt="Talha Avaan"
              className="w-full h-full object-cover"
